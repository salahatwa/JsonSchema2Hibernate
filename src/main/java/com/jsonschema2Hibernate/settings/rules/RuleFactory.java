...
package com.jsonschema2Hibernate.settings.rules;

import com.jsonschema2Hibernate.annotators.Jackson2Annotator;
import com.jsonschema2Hibernate.rules.general.AdditionalPropertiesRule;
import com.jsonschema2Hibernate.rules.general.ArrayRule;
import com.jsonschema2Hibernate.rules.general.DefaultRule;
import com.jsonschema2Hibernate.rules.general.DescriptionRule;
import com.jsonschema2Hibernate.rules.general.DynamicPropertiesRule;
import com.jsonschema2Hibernate.rules.general.EnumRule;
import com.jsonschema2Hibernate.rules.general.FormatRule;
import com.jsonschema2Hibernate.rules.general.JavaNameRule;
import com.jsonschema2Hibernate.rules.general.MediaRule;
import com.jsonschema2Hibernate.rules.general.MinItemsMaxItemsRule;
import com.jsonschema2Hibernate.rules.general.MinLengthMaxLengthRule;
import com.jsonschema2Hibernate.rules.general.MinimumMaximumRule;
import com.jsonschema2Hibernate.rules.general.NotRequiredRule;
import com.jsonschema2Hibernate.rules.general.ObjectRule;
import com.jsonschema2Hibernate.rules.general.PatternRule;
import com.jsonschema2Hibernate.rules.general.PropertiesRule;
import com.jsonschema2Hibernate.rules.general.PropertyRule;
import com.jsonschema2Hibernate.rules.general.RequiredArrayRule;
import com.jsonschema2Hibernate.rules.general.RequiredRule;
import com.jsonschema2Hibernate.rules.general.SchemaRule;
import com.jsonschema2Hibernate.rules.general.TitleRule;
import com.jsonschema2Hibernate.rules.general.TypeRule;
import com.jsonschema2Hibernate.rules.general.ValidRule;
import com.jsonschema2Hibernate.rules.hibernate.AutoIncrementUniqueColumnRule;
import com.jsonschema2Hibernate.rules.hibernate.HibernateAssociationMappingRule;
import com.jsonschema2Hibernate.rules.hibernate.UniqueColumnRule;
...
public class RuleFactory {
    ...
    /**
     * Provides a rule instance that should be applied when a "uniqueColumn"
     * declaration is found in the schema.
     *
     * @return a schema rule that can handle the "uniqueColumn" declaration.
     */
    public Rule<JDocCommentable, JDocCommentable> getUniqueColumnRule() {
        return new UniqueColumnRule();
    }
    
    
    /**
     * Provides a rule instance that should be applied when a "AutoIncrementUniqueColumn"
     * declaration is found in the schema.
     *
     * @return a schema rule that can handle the "AutoIncrementUniqueColumn" declaration.
     */
    public Rule<JDocCommentable, JDocCommentable> getAutoIncrementUniqueColumnRule() {
        return new AutoIncrementUniqueColumnRule();
    }
    
    
    public Rule<JFieldVar, JDefinedClass> getAssociationMappingRule() {
        return new HibernateAssociationMappingRule();
    }
