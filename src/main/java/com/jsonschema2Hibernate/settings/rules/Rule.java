 ...
 */
public abstract class Rule<T, R> implements RulesNames{
     ...
     */
    public  R apply(String nodeName, JsonNode node, T generatableType, Schema currentSchema) {return null;};
    
    
    
    public  void apply(String nodeName, JsonNode node, T generatableType,R clazz, Schema currentSchema) {};
